...
const typographyVariants = cva("text-gray-600 text-normal", {
  variants: {
    variant: {
      ...
      h4: "text-xl md:text-2xl font-semibold tracking-[-0.02em] text-gray-900",
      h5: "text-lg md:text-xl font-semibold tracking-[-0.02em] text-gray-900",
      h6: "text-base md:text-lg font-semibold tracking-[-0.02em] text-gray-900",
